# News Search Client MCP Server

This MCP (Model Content Protocol) server provides access to News Search Client API functionality through HTTP, HTTPS, and STDIO transport modes.
