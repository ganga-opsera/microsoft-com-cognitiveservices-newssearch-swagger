...
func News_trendingHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/news/trendingtopics%s", cfg.BaseURL, queryString)
		...
		var result models.TrendingTopics
...
func CreateNews_trendingTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    News_trendingHandler(cfg),
	}
}
