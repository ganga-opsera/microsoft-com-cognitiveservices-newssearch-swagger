# microsoft.com API - Version cognitiveservices-NewsSearch
...
- **Version**: cognitiveservices-NewsSearch
- **File**: swagger.yaml
- **Original Path**: microsoft.com/cognitiveservices-NewsSearch/1.0/swagger.yaml
